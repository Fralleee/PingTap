...
public class MatchState : MonoBehaviour
{
  ...
  void Awake()
  {
    ...
    stateMachine.AddTransition(matchStateLive, matchStatePrepare, () => matchManager.enemiesAlive == 0 && waveManager.WavesRemaining);
    stateMachine.AddTransition(matchStateLive, matchStateEnd, () => matchManager.enemiesAlive == 0 && !waveManager.WavesRemaining);
