...
//      movement.OnCrouch += HandleCrouch;
//    }
...
//      rigidBody.AddForce(force * modifier * externalSpeedModifier, ForceMode.VelocityChange);
//      movement.Movement(force * modifier, externalSpeedModifier);
//    }
...
//    void HandleCrouch(bool enter)
//    {
//      SetExternalSpeedModifier(enter ? 0.5f : 1f);
//    }

//    void SetExternalSpeedModifier(float modifier)
//    {
