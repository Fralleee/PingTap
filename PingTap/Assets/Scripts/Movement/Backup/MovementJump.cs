...
//      if (movement.state == PlayerMovementState.Dashing || movement.state == PlayerMovementState.ExternalBlocked) return;

//      if (movement.state == PlayerMovementState.Crouching) movement.Crouch(false);
