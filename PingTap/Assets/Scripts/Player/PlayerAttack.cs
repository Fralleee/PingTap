...
namespace Fralle.BattleSystem
{
  ...
  public class PlayerAttack : MonoBehaviour
  {
    ...
    void FireInput()
    {
      if (Input.GetMouseButtonDown(0)) combatant.PrimaryAction(true);
      else if (Input.GetMouseButton(0)) combatant.PrimaryAction();
      else if (Input.GetMouseButtonDown(1)) combatant.SecondaryAction(true);
      else if (Input.GetMouseButton(1)) combatant.SecondaryAction();
    }
  }
}