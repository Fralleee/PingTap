...
namespace Fralle
{
  public class PlayerInput : MonoBehaviour
  {
    ...
    //{
    //  var mouseSensitivity = PlayerPrefs.GetFloat(Settings.MouseSensitivity.ToString());
    //  mouseSensitivity = Mathf.Clamp(mouseSensitivity, 1, mouseSensitivity);
    //  MouseSensitivity = mouseSensitivity;
    //}

    public void ToggleZoomModifier(bool enabled)
    {
      currentSensitivity = enabled ? MouseSensitivity * MouseZoomModifier : MouseSensitivity;
    }
