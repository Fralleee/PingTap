...
public class URPOutlineFeature : ScriptableRendererFeature
{
  private class SRPOutline : ScriptableRenderPass
  {
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
      ...
      Outliner outlineEffect = Outliner;
      ...
      bool useCustomRenderTarget = Outliner.HasCutomRenderTarget && !renderingData.cameraData.isSceneViewCamera;
  ...
  private class Pool
  {
    ...
    {
      outlines.Clear();
      foreach (SRPOutline outline in createdOutlines)
  ...
  {
    outliners.Clear();
    GameObject camera = renderingData.cameraData.camera.gameObject;
    ...
    if (outliners.Count == 0)
    {
      ...
      {
        Outliner foundObject = Array.Find(
    ...
    bool hasOutliners = outliners.Count > 0;
    if (hasOutliners)
  ...
  public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
  {
...
#if UNITY_2019_3_OR_NEWER && !UNITY_2019_3_0 && !UNITY_2019_3_1 && !UNITY_2019_3_2 && !UNITY_2019_3_3 && !UNITY_2019_3_4 && !UNITY_2019_3_5 && !UNITY_2019_3_6 && !UNITY_2019_3_7 && !UNITY_2019_3_8
    UniversalAdditionalCameraData additionalCameraData = renderingData.cameraData.camera.GetUniversalAdditionalCameraData();
    int activeStackCount = 0;
    if (additionalCameraData != null)
    {
      List<Camera> stack = additionalCameraData.renderType == CameraRenderType.Overlay ? null : additionalCameraData.cameraStack;
      if (stack != null)
      {
    ...
    bool shouldUseDepthTarget = renderingData.cameraData.requiresDepthTexture && renderingData.cameraData.cameraTargetDescriptor.msaaSamples <= 1 && !renderingData.cameraData.isSceneViewCamera;

    foreach (Outliner outliner in outliners)
    {
      SRPOutline outline = outlinePool.Get();
