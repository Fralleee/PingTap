...
namespace SensorToolkit
{
  ...
  public class RangeSensor2D : BaseAreaSensor
  {
    ...
    void testSensor()
    {
      ...
      int numberDetected = Physics2D.OverlapCircleNonAlloc(transform.position, SensorRange, collidersBuffer, DetectsOnLayers);
      ...
      {
        GameObject newDetection = addCollider(collidersBuffer[i]);
      ...
      {
        GameObject lostDetection = previousDetectedEnumerator.Current;
